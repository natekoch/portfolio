    ...
    <div class="flex justify-center">
        <div class="text-center max-w-3xl">
            <div class="avatar my-3">
                <div class="w-48 xl:w-64 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                    <!-- svelte-ignore a11y-img-redundant-alt -->
                    <img src="https://natekochportfolio.s3.us-west-2.amazonaws.com/IMG_0109.JPG" alt="profile picture"/>
                </div>
            </div>
