<body>
    ...
    <div class="mockup-code shadow-2xl border-2 border-secondary">
        <pre data-prefix="$" class="text-accent"><code>cd programming_projects</code></pre> 
        ...
        <a href="https://github.com/natekoch/tac" target="_blank" style="text-decoration: none; color: white;"><pre data-prefix=">" class="hover:bg-secondary hover:text-secondary-content"><code>tac</code></pre></a>
      </div>
</body>