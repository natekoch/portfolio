    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "00043261/07EC667B-4464-4ADB-BB23-8B5B0B322D0A_1_105_c.jpeg")) attr_dev(img, "src", img_src_value);
    			set_style(img, "max-height", "250px");
    			set_style(img, "max-width", "250px");
    			attr_dev(img, "alt", "profile picture");
    			add_location(img, file$1, 6, 12, 350);
    			attr_dev(span, "class", "text-secondary");
    			add_location(span, file$1, 7, 78, 605);
    			attr_dev(h1, "class", "mb-5 text-4xl sm:text-5xl font-bold");
    			add_location(h1, file$1, 7, 12, 539);
    			attr_dev(p, "class", "mb-5");
    			add_location(p, file$1, 8, 12, 689);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 38, 5, 1158);
    			add_location(li, file, 37, 4, 1148);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button2, file, 51, 3, 3341);
    			attr_dev(div3, "class", "navbar-end");
    			add_location(div3, file, 47, 2, 1554);
    			attr_dev(div4, "class", "navbar bg-primary rounded-box");
    			add_location(div4, file, 29, 1, 613);
    			add_location(main, file, 28, 0, 605);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
