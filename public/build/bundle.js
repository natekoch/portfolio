    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			img2 = element("img");
    			if (!src_url_equal(img0.src, img0_src_value = "https://natekochportfolio.s3.us-west-2.amazonaws.com/000432610001.jpg")) attr_dev(img0, "src", img0_src_value);
    			...
    			if (!src_url_equal(img1.src, img1_src_value = "https://natekochportfolio.s3.us-west-2.amazonaws.com/000432610002.jpg")) attr_dev(img1, "src", img1_src_value);
    			...
    			add_location(img1, file$2, 4, 12, 335);
    			if (!src_url_equal(img2.src, img2_src_value = "https://natekochportfolio.s3.us-west-2.amazonaws.com/000432610003.jpg")) attr_dev(img2, "src", img2_src_value);
    			...
    			add_location(img2, file$2, 5, 12, 521);
    			attr_dev(div0, "class", "stack");
    			add_location(div0, file$2, 2, 8, 121);
    			attr_dev(div1, "class", "pt-7 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5");
